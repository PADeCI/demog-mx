...
write.csv(df_pop_state_age, "data/df_pop_state_age.csv")
write.csv(df_pop_state, "data/df_pop_state.csv")
...
#### 02_demographic_rates_states, and 01_01_data_wrangling_counties 
#
#df_birth_state_age <- bind_rows(df_birth_state_age,
#                                  MCMA_birth) %>% 
...
save(df_birth_state_age, file = "data/df_birth_state_age.Rdata")
save(df_birth_state, file = "data/df_birth_state.Rdata")

write.csv(df_birth_state_agegrp, "data/df_birth_state_agegrp.csv")
write.csv(df_birth_state_age, "data/df_birth_state_age.csv")
...
write.csv(df_mort_state_age, "data/df_mort_state_age.csv")
write.csv(df_mort_state, "data/df_mort_state.csv")
